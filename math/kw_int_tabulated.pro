; $Id: //depot/Release/ENVI51_IDL83/idl/idldir/lib/int_tabulated.pro#1 $
;
; Copyright (c) 1995-2013, Exelis Visual Information Solutions, Inc. All
...
;           Modified:    Kyle R. Wodzicki October 2015
;                          Added dimension keyword so that multi-
;                          dimensional arrays could be used
;-

FUNCTION KW_Int_Tabulated, X, F, Double = Double, Sort = Sort, DIMENSION=dimension
...
STOP
  ...
  ;Compute the integral using the 5-point Newton-Cotes formula.
    ...
    CASE dimension OF
      1    : RETURN, FIX(TOTAL(2D * h * $
                    (7D * (z[ii-4,*,*,*,*,*,*,*] + z[ii,*,*,*,*,*,*,*]) + $
                    32D * (z[ii-3,*,*,*,*,*,*,*] + z[ii-1,*,*,*,*,*,*,*]) + $
                    12D * z[ii-2,*,*,*,*,*,*,*]) / 45D, DIMENSION=dimension), TYPE=type) 
      2    : RETURN, FIX(TOTAL(2D * h * $
                    (7D * (z[*,ii-4,*,*,*,*,*,*] + z[*,ii,*,*,*,*,*,*]) + $
                    32D * (z[*,ii-3,*,*,*,*,*,*] + z[*,ii-1,*,*,*,*,*,*]) + $
                    12D * z[*,ii-2,*,*,*,*,*,*]) / 45D, DIMENSION=dimension), TYPE=type)
      3    : RETURN, FIX(TOTAL(2D * h * $
                    (7D * (z[*,*,ii-4,*,*,*,*,*] + z[*,*,ii,*,*,*,*,*]) + $
                    32D * (z[*,*,ii-3,*,*,*,*,*] + z[*,*,ii-1,*,*,*,*,*]) + $
                    12D * z[*,*,ii-2,*,*,*,*,*]) / 45D, DIMENSION=dimension), TYPE=type) 
      4    : RETURN, FIX(TOTAL(2D * h * $
                    (7D * (z[*,*,*,ii-4,*,*,*,*] + z[*,*,*,ii,*,*,*,*]) + $
                    32D * (z[*,*,*,ii-3,*,*,*,*] + z[*,*,*,ii-1,*,*,*,*]) + $
                    12D * z[*,*,*,ii-2,*,*,*,*]) / 45D, DIMENSION=dimension), TYPE=type) 
      5    : RETURN, FIX(TOTAL(2D * h * $
                    (7D * (z[*,*,*,*,ii-4,*,*,*] + z[*,*,*,*,ii,*,*,*]) + $
                    32D * (z[*,*,*,*,ii-3,*,*,*] + z[*,*,*,*,ii-1,*,*,*]) + $
                    12D * z[*,*,*,*,ii-2,*,*,*]) / 45D, DIMENSION=dimension), TYPE=type) 
      6    : RETURN, FIX(TOTAL(2D * h * $
                    (7D * (z[*,*,*,*,*,ii-4,*,*] + z[*,*,*,*,*,ii,*,*]) + $
                    32D * (z[*,*,*,*,*,ii-3,*,*] + z[*,*,*,*,*,ii-1,*,*]) + $
                    12D * z[*,*,*,*,*,ii-2,*,*]) / 45D, DIMENSION=dimension), TYPE=type) 
      7    : RETURN, FIX(TOTAL(2D * h * $
                    (7D * (z[*,*,*,*,*,*,ii-4,*] + z[*,*,*,*,*,*,ii,*]) + $
                    32D * (z[*,*,*,*,*,*,ii-3,*] + z[*,*,*,*,*,*,ii-1,*]) + $
                    12D * z[*,*,*,*,*,*,ii-2,*]) / 45D, DIMENSION=dimension), TYPE=type) 
      8    : RETURN, FIX(TOTAL(2D * h * $
                    (7D * (z[*,*,*,*,*,*,*,ii-4] + z[*,*,*,*,*,*,*,ii]) + $
                    32D * (z[*,*,*,*,*,*,*,ii-3] + z[*,*,*,*,*,*,*,ii-1]) + $
                    12D * z[*,*,*,*,*,*,*,ii-2]) / 45D, DIMENSION=dimension), TYPE=type) 
      ELSE : MESSAGE, 'Dimension must be 8 or smaller!!!'
    ENDCASE
